...
for h=1:num_times
    ...
    [diffuse(:,:,h),direct(:,:,h),diffuseZ(:,:,h),directZ(:,:,h),...
        ...
        gldasInterp.Psurf_f_inst(:,:,h)./1000,...
        ceresInterp.aux_surfpress_3h(:,:,h)./10,...
        gldasInterp.Tair_f_inst(:,:,h),...
    ...
    %solve the energy balance
        [M(:,:,h),Tsfc(:,:,h),Lin(:,:,h),LinZ(:,:,h),...
            ...
            gldasInterp.Qair_f_inst(:,:,h),ceres_topo.Zdiff,gldasInterp.Tair_f_inst(:,:,h),...
            Ta(:,:,h),gldasInterp.Psurf_f_inst(:,:,h)./1000,presZ(:,:,h),...
