function [mu0, mu0_unrefracted, phi0, airmass] = ...
    sunang2( lat, lon, declin, omega, varargin )
% [mu0, mu0_unrefracted, phi0, airmass] = sunang2( lat, lon, declin, omega, ... )
%Sun angles on horizontal surface, with and w/o  correction for
%   refraction
...
%   P - pressure in kPa, to correct for atmospheric path length and
%       refraction, default ignore refraction
%   T - temperature in Kelvin, to correct for atmospheric path length and
%   	refraction, default ignore refraction
%  Output:
%   mu0, cosine of solar zenith angle, refracted
%   mu0_unrefracted, cosine of solar zenith angle, unrefracted (i.e. above
%   atmos)
